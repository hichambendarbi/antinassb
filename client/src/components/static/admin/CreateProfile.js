...
import { createProfile } from '../../../controlers/profile'
    ...
    return (
        <ContainerNewProfile> 
            ...
            <Linkrot to="/dashboard"> <Return fill="#009688" width="30" height="20"/></Linkrot>
                إنشاء ملف شخصي</TitleCreateProfile>
           ...
           <form onSubmit={e=> onSubmit(e)}>
            ...
            <ContainerInputs>
                ...
                <ContSpanInp>
                    ...
                    {/* <InputCP placeholder="البلد" name="location" value={location} onChange={e=> onChange(e)}/> */}
            ...
            <ContainerSocial>
             ...
             {/* Button Create */}
             <ContainerInputs>
              <BtnCreate type="submit">إنشاء</BtnCreate>
             </ContainerInputs>
             </form>
        </ContainerNewProfile>
    )
